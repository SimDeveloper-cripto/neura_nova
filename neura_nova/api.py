...
# TODO [SIMONE]: VERIFICA STESSO RAGIONAMENTO PER MAXPOOLLAYER (ks = 2, stride = 2)
# TODO [SIMONE]: LO SPESSORE DEL FEATURE VOLUME RISULTANTE E' PARI AL NUMERO DI FILTRI? (LAYER DI POOLING)
# TODO [SIMONE]: PADDING NO IPER-PARAMETRO MA VA CALCOLATO PER AVERE H,W UGUALI A H,W IN INPUT
